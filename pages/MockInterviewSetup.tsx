        ...
        <div className="transition-all duration-300">
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-16 items-start">
                ...
                <div className="w-full lg:w-5/12 space-y-4 lg:space-y-8">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl md:rounded-3xl p-5 md:p-6 border border-gray-200 dark:border-slate-800 shadow-lg shadow-gray-100/50 dark:shadow-none">
                        ...
                        <div className="space-y-4">
                            <div className="relative group">
                                ...
                                <input 
                                    ...
                                    className="w-full pl-10 pr-4 py-4 border border-gray-200 dark:border-slate-700 rounded-2xl text-sm bg-gray-50 dark:bg-slate-950 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
                                    value={linkedinUrl}
                ...
                <div className="flex lg:hidden items-center gap-4 w-full my-2">
                    ...
                    <span className="text-xs text-gray-400 dark:text-slate-500 font-bold uppercase tracking-wider px-2">Or Enter Manually</span>
                    <div className="h-px bg-gray-200 dark:bg-slate-800 flex-1"></div>
                </div>

                {/* Right Side: Manual Form */}
                <div className="w-full lg:w-7/12">
                    <div className="bg-white dark:bg-slate-900 p-5 md:p-8 rounded-2xl md:rounded-3xl border border-gray-100 dark:border-slate-800 shadow-xl shadow-gray-200/50 dark:shadow-none">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                            <i className="fas fa-pen-to-square text-primary"></i> Manual Entry
                        </h2>
                        <form onSubmit={handleStart} className="space-y-6">
                        <div className="space-y-2 group">
                            <label className="block text-sm font-bold text-gray-700 dark:text-slate-300 ml-1 group-focus-within:text-primary transition-colors">Job Title</label>
                            <div className="relative">
                <input 
                type="text" 
                required
                placeholder="e.g. Senior Frontend Engineer" 
                className="w-full pl-4 pr-4 py-4 border border-gray-200 dark:border-slate-700 rounded-2xl focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all bg-white dark:bg-slate-900 dark:text-white font-medium placeholder-gray-400 shadow-sm"
                value={jobTitle}
                ...
                />
                        ...
                        <div className="space-y-2 group">
                            <label className="block text-sm font-bold text-gray-700 dark:text-slate-300 ml-1 group-focus-within:text-primary transition-colors">Job Description</label>
                            <div className="relative">
                <textarea 
                required
                rows={6} 
                placeholder="Paste the full job description here..." 
                className="w-full p-4 border border-gray-200 dark:border-slate-700 rounded-2xl focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all bg-white dark:bg-slate-900 dark:text-white resize-none font-medium leading-relaxed placeholder-gray-400 shadow-sm"
                value={jobDesc}
